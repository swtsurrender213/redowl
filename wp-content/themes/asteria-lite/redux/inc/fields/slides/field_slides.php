    ...
    class ReduxFramework_slides extends ReduxFramework
    {
        ...
        public function render()
        {
            ...
            if ($x == 0) {
				...
				//New Field by Towfiq: 
				echo '<li class="ast_trigger"><label>'.__('Slide Text Layout', 'redux-framework').'</lable><br /><br /><a class="sldcont1 astbtn">layout1</a><a class="sldcont2 astbtn">layout2</a><a class="sldcont3 astbtn">layout3</a><input type="hidden" id="' . $this->field['id'] . '-slide_content_' . $x . '" name="' . $this->args['opt_name'] . '[' . $this->field['id'] . '][' . $x . '][slide_content_id]" value="" class="full-text ast_content" /></li>';
