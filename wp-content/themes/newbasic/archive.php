...
<div id="content">
					...
					<?php
						if ( is_day() ) :
							printf( __( 'Daily Archives: %s', 'newbasic' ), get_the_date() );

						elseif ( is_month() ) :
							printf( __( 'Monthly Archives: %s', 'newbasic' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'newbasic' ) ) );

						elseif ( is_year() ) :
							printf( __( 'Yearly Archives: %s', 'newbasic' ), get_the_date( _x( 'Y', 'yearly archives date format', 'newbasic' ) ) );

						else :
							_e( 'Archives', 'newbasic' );
